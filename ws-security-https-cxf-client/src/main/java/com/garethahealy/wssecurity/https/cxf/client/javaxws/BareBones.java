...
public class BareBones {
	...
	public <T> T getEndpoint(WsEndpointConfiguration<?> config) {
		...
		try {
			...
			Service service = createService(classImpl, "file:/Users/garethah/Documents/github/garethahealy/jboss-fuse-examples/ws-security-https-cxf-wsdl-helloworld/src/main/resources/wsdl/helloworld.wsdl");
	...
	private Service createService(Class classImpl, String url) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, MalformedURLException, NoSuchMethodException, SecurityException {
