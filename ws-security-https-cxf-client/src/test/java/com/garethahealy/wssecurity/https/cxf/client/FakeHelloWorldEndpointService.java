...
public class FakeHelloWorldEndpointService implements HelloWorldEndpoint {

    private static final Logger LOG = LoggerFactory.getLogger(FakeHelloWorldEndpointService.class);
